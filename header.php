...
<head>
	...
	<style>
		...
		#bottom-footer {
			background: #000080;
			/* fallback for old browsers */
			background: -webkit-linear-gradient(to right, #348AC7, #000080);
			/* Chrome 10-25, Safari 5.1-6 */
			background: linear-gradient(to right, #348AC7, #000080);
						...
						if (isset($_SESSION["uid"])) {
							...
							echo '
                                <div class="dropdownn">
                                  ...
                                  <div class="dropdownn-content">
                                    <a href="" data-toggle="modal" data-target="#Modal_login"><i class="fa fa-sign-in" aria-hidden="true" ></i>Masuk</a>
